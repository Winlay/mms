...
(function() {
    ...
    var e;
    e = [{title: "All Day Event", start: "2014-06-01", className: "bg-primary-lt"}, {title: "Another All Day Event", start: "2014-06-02", className: "bg-primary-lt"}, {title: "Long Event", start: "2014-06-07", end: "2014-06-10", className: "bg-info-dk"}, {id: 999, title: "Repeating Event", start: "2014-06-09T16:00:00", className: "bg-success"}, {id: 999, title: "Repeating Event", start: "2014-06-16T16:00:00", className: "bg-warning"}, {title: "Meeting", start: "2014-06-12T10:30:00", end: "2014-06-12T12:30:00", className: "bg-danger"}, {title: "Lunch", start: "2014-06-12T12:00:00", className: "bg-primary-lt"}, {title: "Birthday Party", start: "2014-06-13T07:00:00", className: "bg-primary-lt"}, {title: "Click for Google", url: "http://google.com/", start: "2014-06-28", className: "bg-light"}, {title: "Extra event", url: "http://google.com/", start: "2014-06-29", className: "bg-primary-lt"}], $(document).on("ready page:load", function() {
...
$(cb), $document = $(document), $document.on("page:load", cb), function() {
    ...
    $(document).on("ready page:load", function() {
        ...
        return e = function() {
            ...
            var t, s;
            return t = $(this), s = EmVars.colorFromName(t.data("color") || "info"), $.plot(t, [{data: e()}], {series: {lines: {show: !0, lineWidth: 1, fill: !0, fillColor: {colors: [{opacity: .3}, {opacity: .3}]}}, points: {radius: 3, show: !0}, grow: {active: !0, steps: 50}, shadowSize: 2}, grid: {hoverable: !0, clickable: !0, tickColor: EmVars.colors.light.color, borderWidth: 1, color: EmVars.colors.light.color}, colors: [s], xaxis: {}, yaxis: {ticks: 5}, tooltip: !0, tooltipOpts: {content: "chart: %x.1 is %y.4", defaultTheme: !1, shifts: {x: 0, y: 20}}})
        })
    })
}.call(this), function() {
    $(document).on("ready page:load", function() {
    ...
    $(document).on("ready page:load", function() {
        ...
        return e = function() {
            ...
            return $.plot($(this), [{data: e(), label: "Unique Visits"}, {data: e(), label: "Page Views"}], {series: {lines: {show: !0, lineWidth: 1, fill: !0, fillColor: {colors: [{opacity: .3}, {opacity: .3}]}}, points: {show: !0}, shadowSize: 2}, grid: {hoverable: !0, clickable: !0, tickColor: EmVars.colors.light.color, borderWidth: 0}, colors: [EmVars.colors.success.color, EmVars.colors.primary.color], xaxis: {ticks: 15, tickDecimals: 0}, yaxis: {ticks: 10, tickDecimals: 0}, tooltip: !0, tooltipOpts: {content: "'%s' of %x.1 is %y.4", defaultTheme: !1, shifts: {x: 0, y: 20}}})
        })
    })
}.call(this), function() {
    $(document).on("ready page:load", function() {
    ...
    $(document).on("ready page:load", function() {
        ...
        return e = EmVars.helpers.abbrDays, s = function() {
            ...
            return r = $(this), o = {useXAxisLines: !0, useXAxisLabels: !0, useYAxisLines: !0, useYAxisLabels: !0}, (null != r.data("flot-no-x-lines") || null != r.data("flot-no-lines")) && (o.useXAxisLines = !1), (null != r.data("flot-no-x-labels") || null != r.data("flot-no-labels")) && (o.useXAxisLabels = !1), (null != r.data("flot-no-y-lines") || null != r.data("flot-no-lines")) && (o.useYAxisLines = !1), (null != r.data("flot-no-y-labels") || null != r.data("flot-no-labels")) && (o.useYAxisLabels = !1), n = s(), l = _.min(_.map(n, function(e) {
                ...
                return[t[0], e[t[0]]]
            }), c.font = {color: a}) : c.tickFormatter = t, p = {min: l - 5, ticks: 5}, p.tickColor = o.useYAxisLines ? u : "transparent", o.useYAxisLabels ? (p.font = {color: a}, p.tickFormatter = i) : p.tickFormatter = t, $.plot(r, [{data: n}], {series: {lines: {show: !0, lineWidth: 2, fill: !0, fillColor: {colors: [{opacity: 0}, {opacity: 0}]}}, points: {radius: 3, show: !0, fillColor: "white"}, shadowSize: 0}, grid: {hoverable: !0, clickable: !0, tickColor: u, borderWidth: 0, color: u}, colors: [a], xaxis: c, yaxis: p, tooltip: !0, tooltipOpts: {content: "%y.1MB/s", defaultTheme: !1, shifts: {x: 0, y: 20}}})
        })
    })
}.call(this), function() {
    $(document).on("ready page:load", function() {
